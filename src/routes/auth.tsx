      ...
      <section className="mx-auto flex max-w-md flex-col px-6 py-20">
        ...
        <form onSubmit={submit} className="mt-8 space-y-4 rounded-sm border border-border bg-card p-6">
          <button
            ...
            className="flex w-full items-center justify-center gap-2 rounded-sm border border-border bg-background py-2.5 text-sm font-medium hover:bg-secondary"
          >
          ...
          <div className="relative my-2 text-center"><span className="bg-card px-2 text-[10px] uppercase tracking-widest text-muted-foreground">or email</span><div className="absolute left-0 right-0 top-1/2 -z-10 h-px bg-border" /></div>
          {mode === "signup" && (
            <div>
